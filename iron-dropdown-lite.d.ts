 ...
 *     </iron-dropdown>
 */
interface IronDropdownLiteElement extends Polymer.Element, Polymer.IronControlState, Polymer.IronA11yKeysBehavior, Polymer.IronOverlayBehavior {
   ...
   * `iron-dropdown` doesn't depend anymore on `neon-animation`, and this
   * property is kept here to not break bindings. Setting it won't have
   * effects on the animation.
   */
...
interface HTMLElementTagNameMap {
  "iron-dropdown-lite": IronDropdownLiteElement;
}
